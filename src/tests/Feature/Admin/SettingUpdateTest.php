...
class SettingUpdateTest extends TestCase
{
    ...
    public function testUpdateSettingsAsAdmin()
    {
        ...
        $this->assertEquals('es', Setting::where('name', 'language')->first()->getTypedValue());
        $this->assertEquals('New Title', Setting::where('name', 'bmltTitle')->first()->getTypedValue());
        $this->assertFalse(Setting::where('name', 'autoGeocodingEnabled')->first()->getTypedValue());
    }
    ...
    public function testUpdateSingleSetting()
    {
        ...
        $this->assertEquals('en', Setting::where('name', 'language')->first()->getTypedValue());
        $this->assertEquals('Updated Title Only', Setting::where('name', 'bmltTitle')->first()->getTypedValue());
    }
    ...
    public function testUpdateArraySetting()
    {
        ...
        $this->assertEquals(['CA', 'NY', 'TX'], $setting->getTypedValue());
    }
    ...
    public function testUpdateNumericSettings()
    {
        ...
        $this->assertEquals(10, Setting::where('name', 'searchSpecMapCenterZoom')->first()->getTypedValue());
        $this->assertEquals(40.7128, Setting::where('name', 'searchSpecMapCenterLatitude')->first()->getTypedValue());
    }
