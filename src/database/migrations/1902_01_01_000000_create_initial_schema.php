        ...
        if (Schema::hasTable('comdef_formats')) {
            ...
            if (!file_config('aggregator_mode_enabled')) {
                ...
                DB::table('comdef_formats')->insert([
                    ...
                    ['shared_id_bigint' => 1, 'key_string' => 'B', 'worldid_mixed' => 'BEG', 'lang_enum' => 'da', 'name_string' => 'Beginners', 'description_string' => 'This meeting is focused on the needs of new members of NA.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 2, 'key_string' => 'BL', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'Bi-Lingual', 'description_string' => 'This Meeting can be attended by speakers of English and another language.', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 3, 'key_string' => 'BT', 'worldid_mixed' => 'BT', 'lang_enum' => 'da', 'name_string' => 'Basic Text', 'description_string' => 'This meeting is focused on discussion of the Basic Text of Narcotics Anonymous.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 4, 'key_string' => 'C', 'worldid_mixed' => 'CLOSED', 'lang_enum' => 'da', 'name_string' => 'Closed', 'description_string' => 'This meeting is closed to non-addicts. You should attend only if you believe that you may have a problem with substance abuse.', 'format_type_enum' => 'O'],
                    ['shared_id_bigint' => 5, 'key_string' => 'CH', 'worldid_mixed' => 'CH', 'lang_enum' => 'da', 'name_string' => 'Closed Holidays', 'description_string' => 'This meeting gathers in a facility that is usually closed on holidays.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 6, 'key_string' => 'CL', 'worldid_mixed' => 'CAN', 'lang_enum' => 'da', 'name_string' => 'Candlelight', 'description_string' => 'This meeting is held by candlelight.', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 7, 'key_string' => 'CS', 'worldid_mixed' => '', 'lang_enum' => 'da', 'name_string' => 'Children under Supervision', 'description_string' => 'Well-behaved, supervised children are welcome.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 8, 'key_string' => 'D', 'worldid_mixed' => 'DISC', 'lang_enum' => 'da', 'name_string' => 'Discussion', 'description_string' => 'This meeting invites participation by all attendees.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 9, 'key_string' => 'ES', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'Español', 'description_string' => 'This meeting is conducted in Spanish.', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 10, 'key_string' => 'GL', 'worldid_mixed' => 'GL', 'lang_enum' => 'da', 'name_string' => 'Gay/Lesbian/Transgender', 'description_string' => 'This meeting is focused on the needs of gay, lesbian and transgender members of NA.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 11, 'key_string' => 'IL', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Illness', 'description_string' => 'This meeting is focused on the needs of NA members with chronic illness.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 12, 'key_string' => 'IP', 'worldid_mixed' => 'IP', 'lang_enum' => 'da', 'name_string' => 'Informational Pamphlet', 'description_string' => 'This meeting is focused on discussion of one or more Informational Pamphlets.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 13, 'key_string' => 'IW', 'worldid_mixed' => 'IW', 'lang_enum' => 'da', 'name_string' => 'It Works -How and Why', 'description_string' => 'This meeting is focused on discussion of the It Works -How and Why text.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 14, 'key_string' => 'JT', 'worldid_mixed' => 'JFT', 'lang_enum' => 'da', 'name_string' => 'Just for Today', 'description_string' => 'This meeting is focused on discussion of the Just For Today text.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 15, 'key_string' => 'M', 'worldid_mixed' => 'M', 'lang_enum' => 'da', 'name_string' => 'Men', 'description_string' => 'This meeting is meant to be attended by men only.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 16, 'key_string' => 'NC', 'worldid_mixed' => 'NC', 'lang_enum' => 'da', 'name_string' => 'No Children', 'description_string' => 'Please do not bring children to this meeting.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 17, 'key_string' => 'O', 'worldid_mixed' => 'OPEN', 'lang_enum' => 'da', 'name_string' => 'Open', 'description_string' => 'This meeting is open to addicts and non-addicts alike. All are welcome.', 'format_type_enum' => 'O'],
                    ['shared_id_bigint' => 18, 'key_string' => 'Pi', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Pitch', 'description_string' => 'This meeting has a format that consists of each person who shares picking the next person.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 19, 'key_string' => 'RF', 'worldid_mixed' => 'VAR', 'lang_enum' => 'da', 'name_string' => 'Rotating Format', 'description_string' => 'This meeting has a format that changes for each meeting.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 20, 'key_string' => 'Rr', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Round Robin', 'description_string' => 'This meeting has a fixed sharing order (usually a circle.)', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 21, 'key_string' => 'SC', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Security Cameras', 'description_string' => 'This meeting is held in a facility that has security cameras.', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 22, 'key_string' => 'SD', 'worldid_mixed' => 'S-D', 'lang_enum' => 'da', 'name_string' => 'Speaker/Discussion', 'description_string' => 'This meeting is lead by a speaker, then opened for participation by attendees.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 23, 'key_string' => 'SG', 'worldid_mixed' => 'SWG', 'lang_enum' => 'da', 'name_string' => 'Step Working Guide', 'description_string' => 'This meeting is focused on discussion of the Step Working Guide text.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 24, 'key_string' => 'SL', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'ASL', 'description_string' => 'This meeting provides an American Sign Language (ASL) interpreter for the deaf.', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 26, 'key_string' => 'So', 'worldid_mixed' => 'SPK', 'lang_enum' => 'da', 'name_string' => 'Speaker Only', 'description_string' => 'This meeting is a speaker-only meeting. Other attendees do not participate in the discussion.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 27, 'key_string' => 'St', 'worldid_mixed' => 'STEP', 'lang_enum' => 'da', 'name_string' => 'Step', 'description_string' => 'This meeting is focused on discussion of the Twelve Steps of NA.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 28, 'key_string' => 'Ti', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Timer', 'description_string' => 'This meeting has sharing time limited by a timer.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 29, 'key_string' => 'To', 'worldid_mixed' => 'TOP', 'lang_enum' => 'da', 'name_string' => 'Topic', 'description_string' => 'This meeting is based upon a topic chosen by a speaker or by group conscience.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 30, 'key_string' => 'Tr', 'worldid_mixed' => 'TRAD', 'lang_enum' => 'da', 'name_string' => 'Tradition', 'description_string' => 'This meeting is focused on discussion of the Twelve Traditions of NA.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 31, 'key_string' => 'TW', 'worldid_mixed' => 'TRAD', 'lang_enum' => 'da', 'name_string' => 'Traditions Workshop', 'description_string' => 'This meeting engages in detailed discussion of one or more of the Twelve Traditions of N.A.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 32, 'key_string' => 'W', 'worldid_mixed' => 'W', 'lang_enum' => 'da', 'name_string' => 'Women', 'description_string' => 'This meeting is meant to be attended by women only.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 33, 'key_string' => 'WC', 'worldid_mixed' => 'WCHR', 'lang_enum' => 'da', 'name_string' => 'Wheelchair', 'description_string' => 'This meeting is wheelchair accessible.', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 34, 'key_string' => 'YP', 'worldid_mixed' => 'Y', 'lang_enum' => 'da', 'name_string' => 'Young People', 'description_string' => 'This meeting is focused on the needs of younger members of NA.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 35, 'key_string' => 'OE', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Open-Ended', 'description_string' => 'No fixed duration. The meeting continues until everyone present has had a chance to share.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 36, 'key_string' => 'BK', 'worldid_mixed' => 'LIT', 'lang_enum' => 'da', 'name_string' => 'Book Study', 'description_string' => 'Approved N.A. Books', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 37, 'key_string' => 'NS', 'worldid_mixed' => 'NS', 'lang_enum' => 'da', 'name_string' => 'No Smoking', 'description_string' => 'Smoking is not allowed at this meeting.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 38, 'key_string' => 'Ag', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Agnostic', 'description_string' => 'Intended for people with varying degrees of Faith.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 39, 'key_string' => 'FD', 'worldid_mixed' => null, 'lang_enum' => 'da', 'name_string' => 'Five and Dime', 'description_string' => 'Discussion of the Fifth Step and the Tenth Step', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 40, 'key_string' => 'AB', 'worldid_mixed' => 'QA', 'lang_enum' => 'da', 'name_string' => 'Ask-It-Basket', 'description_string' => 'A topic is chosen from suggestions placed into a basket.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 41, 'key_string' => 'ME', 'worldid_mixed' => 'MED', 'lang_enum' => 'da', 'name_string' => 'Meditation', 'description_string' => 'This meeting encourages its participants to engage in quiet meditation.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 42, 'key_string' => 'RA', 'worldid_mixed' => 'RA', 'lang_enum' => 'da', 'name_string' => 'Restricted Attendance', 'description_string' => 'This facility places restrictions on attendees.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 43, 'key_string' => 'QA', 'worldid_mixed' => 'QA', 'lang_enum' => 'da', 'name_string' => 'Question and Answer', 'description_string' => 'Attendees may ask questions and expect answers from Group members.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 44, 'key_string' => 'CW', 'worldid_mixed' => 'CW', 'lang_enum' => 'da', 'name_string' => 'Children Welcome', 'description_string' => 'Children are welcome at this meeting.', 'format_type_enum' => 'FC3'],
                    ['shared_id_bigint' => 45, 'key_string' => 'CP', 'worldid_mixed' => 'CPT', 'lang_enum' => 'da', 'name_string' => 'Concepts', 'description_string' => 'This meeting is focused on discussion of the twelve concepts of NA.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 46, 'key_string' => 'FIN', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'Finnish', 'description_string' => 'Finnish speaking meeting', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 47, 'key_string' => 'ENG', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'English speaking', 'description_string' => 'This Meeting can be attended by speakers of English.', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 48, 'key_string' => 'PER', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'Persian', 'description_string' => 'Persian speaking meeting', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 49, 'key_string' => 'L/R', 'worldid_mixed' => 'LANG', 'lang_enum' => 'da', 'name_string' => 'Lithuanian/Russian', 'description_string' => 'Lithuanian/Russian Speaking Meeting', 'format_type_enum' => 'LANG'],
                    ['shared_id_bigint' => 51, 'key_string' => 'LC', 'worldid_mixed' => 'LC', 'lang_enum' => 'da', 'name_string' => 'Living Clean', 'description_string' => 'This is a discussion of the NA book Living Clean -The Journey Continues.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 52, 'key_string' => 'GP', 'worldid_mixed' => 'GP', 'lang_enum' => 'da', 'name_string' => 'Guiding Principles', 'description_string' => 'This is a discussion of the NA book Guiding Principles - The Spirit of Our Traditions.', 'format_type_enum' => 'FC1'],
                    ['shared_id_bigint' => 54, 'key_string' => 'VM', 'worldid_mixed' => 'VM', 'lang_enum' => 'da', 'name_string' => 'Virtual Meeting', 'description_string' => 'Meets Virtually', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 55, 'key_string' => 'TC', 'worldid_mixed' => 'TC', 'lang_enum' => 'da', 'name_string' => 'Temporarily Closed Facility', 'description_string' => 'Facility is Temporarily Closed', 'format_type_enum' => 'FC2'],
                    ['shared_id_bigint' => 56, 'key_string' => 'HY', 'worldid_mixed' => 'HYBR', 'lang_enum' => 'da', 'name_string' => 'Hybrid Meeting', 'description_string' => 'Meets Virtually and In-person', 'format_type_enum' => 'FC2'],
