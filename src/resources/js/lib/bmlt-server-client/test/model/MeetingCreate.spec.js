...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.MeetingCreate();
  });
  ...
  describe('MeetingCreate', function() {
    it('should create an instance of MeetingCreate', function() {
      // uncomment below and update the code to test MeetingCreate
      //var instance = new Bmlt.MeetingCreate();
      //expect(instance).to.be.a(Bmlt.MeetingCreate);
    });
