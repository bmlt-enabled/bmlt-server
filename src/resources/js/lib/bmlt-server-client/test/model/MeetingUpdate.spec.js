...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.MeetingUpdate();
  });
  ...
  describe('MeetingUpdate', function() {
    it('should create an instance of MeetingUpdate', function() {
      // uncomment below and update the code to test MeetingUpdate
      //var instance = new Bmlt.MeetingUpdate();
      //expect(instance).to.be.a(Bmlt.MeetingUpdate);
    });
