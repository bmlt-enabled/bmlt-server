...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.FormatPartialUpdate();
  });
  ...
  describe('FormatPartialUpdate', function() {
    it('should create an instance of FormatPartialUpdate', function() {
      // uncomment below and update the code to test FormatPartialUpdate
      //var instance = new Bmlt.FormatPartialUpdate();
      //expect(instance).to.be.a(Bmlt.FormatPartialUpdate);
    });
