...
(function(root, factory) {
  ...
  describe('MeetingBase', function() {
    it('should create an instance of MeetingBase', function() {
      // uncomment below and update the code to test MeetingBase
      //var instance = new Bmlt.MeetingBase();
      //expect(instance).to.be.a(Bmlt.MeetingBase);
    });
