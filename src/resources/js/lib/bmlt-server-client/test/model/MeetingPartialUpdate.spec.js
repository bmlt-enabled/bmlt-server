...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.MeetingPartialUpdate();
  });
  ...
  describe('MeetingPartialUpdate', function() {
    it('should create an instance of MeetingPartialUpdate', function() {
      // uncomment below and update the code to test MeetingPartialUpdate
      //var instance = new Bmlt.MeetingPartialUpdate();
      //expect(instance).to.be.a(Bmlt.MeetingPartialUpdate);
    });
