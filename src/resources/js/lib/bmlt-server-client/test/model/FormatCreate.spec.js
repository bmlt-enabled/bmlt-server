...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.FormatCreate();
  });
  ...
  describe('FormatCreate', function() {
    it('should create an instance of FormatCreate', function() {
      // uncomment below and update the code to test FormatCreate
      //var instance = new Bmlt.FormatCreate();
      //expect(instance).to.be.a(Bmlt.FormatCreate);
    });
