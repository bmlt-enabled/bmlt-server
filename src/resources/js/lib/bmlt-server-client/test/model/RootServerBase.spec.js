...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.RootServerBase();
  });
  ...
  describe('RootServerBase', function() {
    it('should create an instance of RootServerBase', function() {
      // uncomment below and update the code to test RootServerBase
      //var instance = new Bmlt.RootServerBase();
      //expect(instance).to.be.a(Bmlt.RootServerBase);
    });
