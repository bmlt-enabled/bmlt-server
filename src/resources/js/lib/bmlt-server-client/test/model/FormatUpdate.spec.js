...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bmlt.FormatUpdate();
  });
  ...
  describe('FormatUpdate', function() {
    it('should create an instance of FormatUpdate', function() {
      // uncomment below and update the code to test FormatUpdate
      //var instance = new Bmlt.FormatUpdate();
      //expect(instance).to.be.a(Bmlt.FormatUpdate);
    });
