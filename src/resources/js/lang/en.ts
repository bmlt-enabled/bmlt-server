...
export const enTranslations = {
  ...
  addCountiesOrSubProvincesWhereMeetingsAreHeld: 'Add counties or sub-provinces where meetings are held',
  ...
  defaultClosedStatus: 'Default Closed Status (for NAWS export)',
  ...
  editUser: 'Edit User',
  emailTitle: 'Email',
  enableAutoGeocoding: 'Enable Auto Geocoding',
  enableCountyAutoGeocoding: 'Enable County Auto Geocoding',
  enableLanguageSelector: 'Enable Language Selector',
  enableMultiLingual: 'Enable Multi-Lingual Meeting Location Translations',
  enableZipAutoGeocoding: 'Enable ZIP Auto Geocoding',
  error: 'Error',
  errorDownloading: 'Error Downloading',
  errors: 'Errors',
  extraInfoTitle: 'Extra Info',
  fieldVisibilityAuthenticatedOnly: 'These fields are only visible to authenticated users',
  ...
  formatId: 'Format ID',
  formatLangNames: 'Format Language Names (Advanced)',
  formatLangNamesHelperText:
    'Specify custom language names for format translations not included in the server. This is an advanced feature—consider requesting official translations instead. Example: ga → Gaelic',
  ...
  hybrid: 'Hybrid',
  idTitle: 'ID',
  includeServiceBodyEmailInSemanticOutput: 'Include Service Body Email in Semantic Output',
  inPerson: 'In-Person',
  ...
  mapCenterLocation: 'Map Center Location',
  mapsAndGeocoding: 'Maps & Geocoding',
  meeting: 'meeting',
  meetingCountiesSubProvinces: 'Meeting Counties/Sub-Provinces',
  ...
  more: 'more',
  multiLingualHelperText: 'The Cloud Translation API must be enabled on your Google API key for auto-translate to work.',
  myBmltServer: 'My BMLT Server',
  nameTitle: 'Name',
  nationTitle: 'Nation',
  ...
  notFound: 'Not found',
  noticeMessageDisplayedToUsers: 'Notice message displayed to users',
  ...
  numberOfMeetingsForAutoSearch: 'Number of Meetings for Auto Search',
  ...
  serviceBodyDeleteForceWarning: 'This will permanently delete the service body and all of its meetings. This action cannot be undone.',
  serviceBodyDeleteWithMeetings: 'This service body has meetings. You must force delete to remove both the service body and its meetings.',
  serviceBodyForceDelete: 'Force delete (also deletes all meetings)',
  serviceBodyHasMeetings: 'meetings will be deleted',
  serviceBodyId: 'Service Body ID',
