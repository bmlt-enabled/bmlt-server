...
<form use:form>
  <div class="space-y-6">
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
      <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">General Settings</h3>
      <div class="grid gap-4 md:grid-cols-2">
        <div class="md:col-span-2">
          <Label for="bmltTitle" class="mb-2">Server Title</Label>
          <Input type="text" id="bmltTitle" name="bmltTitle" placeholder="My BMLT Server" />
        ...
        <div class="md:col-span-2">
          <Label for="bmltNotice" class="mb-2">Server Notice</Label>
          <Textarea id="bmltNotice" name="bmltNotice" placeholder="Notice message displayed to users" rows={3} class="w-full" />
          <Helper class="mt-2" color="red">
        ...
        <div>
          <Label for="language" class="mb-2">Default Language</Label>
        ...
        <div>
          <Label class="mb-2">Default Meeting Duration</Label>
        ...
        <div class="md:col-span-2">
          <Checkbox name="enableLanguageSelector" bind:checked={$data.enableLanguageSelector}>Enable Language Selector</Checkbox>
        </div>
      </div>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
      <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Maps & Geocoding</h3>
      <div class="grid gap-4 md:grid-cols-2">
        <div class="md:col-span-2">
          <Label for="googleApiKey" class="mb-2">Google Maps API Key</Label>
          <Input type="text" id="googleApiKey" name="googleApiKey" placeholder="Your Google Maps API Key" />
          <Helper class="mt-2" color="red">
        ...
        <div>
          <Label for="distanceUnits" class="mb-2">Distance Units</Label>
        ...
        <div>
          <Label for="regionBias" class="mb-2">Region Bias</Label>
        ...
        <div class="md:col-span-2">
          <MapAccordion title="Map Center Location">
            <div class="grid gap-4 md:grid-cols-3">
              <div>
                <Label for="searchSpecMapCenterLatitude" class="mb-2">Latitude</Label>
              ...
              <div>
                <Label for="searchSpecMapCenterLongitude" class="mb-2">Longitude</Label>
              ...
              <div>
                <Label for="searchSpecMapCenterZoom" class="mb-2">Zoom Level</Label>
        ...
        <div>
          <Label for="numberOfMeetingsForAuto" class="mb-2">Number of Meetings for Auto Search</Label>
          <Input type="number" id="numberOfMeetingsForAuto" name="numberOfMeetingsForAuto" min="0" />
          <Helper class="mt-2">Target number of meetings to find when searching by address without a radius. Higher values expand the search radius to find more meetings.</Helper>
          <Helper class="mt-2" color="red">
        ...
        <div class="space-y-2 md:col-span-2">
          <Checkbox name="autoGeocodingEnabled" bind:checked={$data.autoGeocodingEnabled}>Enable Auto Geocoding</Checkbox>
          <Checkbox name="countyAutoGeocodingEnabled" bind:checked={$data.countyAutoGeocodingEnabled}>Enable County Auto Geocoding</Checkbox>
          <Checkbox name="zipAutoGeocodingEnabled" bind:checked={$data.zipAutoGeocodingEnabled}>Enable ZIP Auto Geocoding</Checkbox>
        </div>
      </div>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
      <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Meeting Settings</h3>
      <div class="grid gap-4 md:grid-cols-2">
        <div>
          <Label for="changeDepthForMeetings" class="mb-2">Change History Depth</Label>
        ...
        <div>
          <Label for="defaultSortKey" class="mb-2">Default Sort Key</Label>
        ...
        <div class="md:col-span-2">
          <Checkbox name="defaultClosedStatus" bind:checked={$data.defaultClosedStatus}>Default Closed Status (for NAWS export)</Checkbox>
        </div>
        <div class="md:col-span-2">
          <Label class="mb-2">Meeting States/Provinces</Label>
          <TagInput bind:value={meetingStates} placeholder="Add state/province (e.g., NY, MA)" />
          <Helper class="mt-2">Add states or provinces where meetings are held</Helper>
        </div>
        <div class="md:col-span-2">
          <Label class="mb-2">Meeting Counties/Sub-Provinces</Label>
          <TagInput bind:value={meetingCounties} placeholder="Add county/sub-province (e.g., Berkshire, Dukes)" />
          <Helper class="mt-2">Add counties or sub-provinces where meetings are held</Helper>
        </div>
      </div>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
      <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Advanced Settings</h3>
      <div class="space-y-4">
        <Checkbox name="includeServiceBodyEmailInSemantic" bind:checked={$data.includeServiceBodyEmailInSemantic}>Include Service Body Email in Semantic Output</Checkbox>

        <MapAccordion title="Format Language Names (Advanced)">
          <KeyValueEditor
            bind:value={formatLangNames}
            helperText="Specify custom language names for format translations not included in the server. This is an advanced legacy feature—consider requesting official translations instead. Example: ga → Irish Gaelic"
            keyPlaceholder="ga"
            valuePlaceholder="Irish Gaelic"
          />
        </MapAccordion>
      </div>
    </div>
    ...
    <div class="flex justify-end">
      <Button type="submit" disabled={!$isDirty} onclick={disableButtonHack} class="w-full md:w-auto">Save Settings</Button>
    </div>
  </div>
</form>
