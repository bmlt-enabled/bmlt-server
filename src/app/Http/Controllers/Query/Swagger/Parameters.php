...
#[OA\Parameter(parameter: 'SemAdvancedPublished', name: 'advanced_published', in: 'query', description: 'Published-status filter. `1` (default) returns only published meetings, `0` returns both, `-1` returns only unpublished (requires authentication).', schema: new OA\Schema(type: 'integer', default: 1, enum: [1, 0, -1]))]
