 ...
 *     @OA\Property(property="aggregatorModeEnabled", type="boolean"),
 *     @OA\Property(property="aggregatorMaxGeoWidthKm", type="number", format="float"),
 ...
 *     @OA\Property(property="aggregatorModeEnabled", type="boolean", example=false),
 *     @OA\Property(property="aggregatorMaxGeoWidthKm", type="number", format="float", example=1000.0),
