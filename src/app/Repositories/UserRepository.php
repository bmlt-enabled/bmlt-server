...
class UserRepository implements UserRepositoryInterface
{
    ...
    private function saveChange(?User $beforeUser, ?User $afterUser): void
    {
        ...
        Change::create([
            ...
            'lang_enum' => $beforeUser?->lang_enum ?: $afterUser?->lang_enum ?: config('app.locale'),
            'object_class_string' => 'c_comdef_user',
            'before_id_bigint' => $beforeUser?->id_bigint,
            'before_lang_enum' => !is_null($beforeUser) ? $beforeUser?->lang_enum ?: config('app.locale') : null,
            'after_id_bigint' => $afterUser?->id_bigint,
            'after_lang_enum' => !is_null($afterUser) ? $afterUser?->lang_enum ?: config('app.locale') : null,
